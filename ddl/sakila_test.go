...
ALTER TABLE public.category ADD CONSTRAINT category_category_id_pkey PRIMARY KEY (category_id);`
...
ALTER TABLE db.category ADD CONSTRAINT category_category_id_pkey PRIMARY KEY (category_id);`
...
ALTER TABLE public.country ADD CONSTRAINT country_country_id_pkey PRIMARY KEY (country_id);`
...
ALTER TABLE db.country ADD CONSTRAINT country_country_id_pkey PRIMARY KEY (country_id);`
...
ALTER TABLE public.city ADD CONSTRAINT city_city_id_pkey PRIMARY KEY (city_id);
...
ALTER TABLE db.city ADD CONSTRAINT city_city_id_pkey PRIMARY KEY (city_id);
...
ALTER TABLE public.address ADD CONSTRAINT address_address_id_pkey PRIMARY KEY (address_id);
...
ALTER TABLE db.address ADD CONSTRAINT address_address_id_pkey PRIMARY KEY (address_id);
...
ALTER TABLE public.language ADD CONSTRAINT language_language_id_pkey PRIMARY KEY (language_id);`
...
ALTER TABLE db.language ADD CONSTRAINT language_language_id_pkey PRIMARY KEY (language_id);`
...
ALTER TABLE public.film ADD CONSTRAINT film_film_id_pkey PRIMARY KEY (film_id);
...
ALTER TABLE db.film ADD CONSTRAINT film_film_id_pkey PRIMARY KEY (film_id);
...
ALTER TABLE db.film ADD CONSTRAINT film_release_year_check CHECK (release_year >= 1901 AND release_year <= 2155);
...
ALTER TABLE public.staff ADD CONSTRAINT staff_staff_id_pkey PRIMARY KEY (staff_id);
...
ALTER TABLE db.staff ADD CONSTRAINT staff_staff_id_pkey PRIMARY KEY (staff_id);
...
ALTER TABLE public.store ADD CONSTRAINT store_store_id_pkey PRIMARY KEY (store_id);
...
ALTER TABLE db.store ADD CONSTRAINT store_store_id_pkey PRIMARY KEY (store_id);
...
ALTER TABLE public.customer ADD CONSTRAINT customer_email_first_name_last_name_key UNIQUE (email, first_name, last_name);
ALTER TABLE public.customer ADD CONSTRAINT customer_customer_id_pkey PRIMARY KEY (customer_id);
...
ALTER TABLE db.customer ADD CONSTRAINT customer_email_first_name_last_name_key UNIQUE (email, first_name, last_name);
ALTER TABLE db.customer ADD CONSTRAINT customer_customer_id_pkey PRIMARY KEY (customer_id);
ALTER TABLE db.customer ADD CONSTRAINT customer_email_key UNIQUE (email);
...
ALTER TABLE public.inventory ADD CONSTRAINT inventory_inventory_id_pkey PRIMARY KEY (inventory_id);
...
ALTER TABLE db.inventory ADD CONSTRAINT inventory_inventory_id_pkey PRIMARY KEY (inventory_id);
...
ALTER TABLE public.rental ADD CONSTRAINT rental_rental_id_pkey PRIMARY KEY (rental_id);
...
ALTER TABLE db.rental ADD CONSTRAINT rental_rental_id_pkey PRIMARY KEY (rental_id);
...
ALTER TABLE public.payment ADD CONSTRAINT payment_payment_id_pkey PRIMARY KEY (payment_id);
...
ALTER TABLE db.payment ADD CONSTRAINT payment_payment_id_pkey PRIMARY KEY (payment_id);
...
ALTER TABLE public.dummy_table ADD CONSTRAINT dummy_table_id1_id2_pkey PRIMARY KEY (id1, id2);
...
ALTER TABLE db.dummy_table ADD CONSTRAINT dummy_table_id1_id2_pkey PRIMARY KEY (id1, id2);
